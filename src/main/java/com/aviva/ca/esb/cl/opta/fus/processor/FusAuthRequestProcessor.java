...
public class FusAuthRequestProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		addType.setMunicipality(req.getDwellingFireProtectionRequest().getMunicipality());
		addType.setStreetName(req.getDwellingFireProtectionRequest().getStreetName());
		addType.setPostalCode(req.getDwellingFireProtectionRequest().getPostalCode());
		addType.setProvince(req.getDwellingFireProtectionRequest().getProvince());
		RequestedIndustryCodeType icode = new RequestedIndustryCodeType();
		icode.setIBCCode(req.getDwellingFireProtectionRequest().getIbcCode());
		icode.setSICCode(req.getDwellingFireProtectionRequest().getSicCode());
		icode.setNAICSCode(req.getDwellingFireProtectionRequest().getNaicsCode());
